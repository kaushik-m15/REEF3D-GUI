...
function StlViewer(e, t) {
  ...
  (this.error = null),
    ...
    (this.max_model_id = 0),
    (this.load_status = new Array()),
    (this.load_session = 0),
    (this.loaded_models_arr = new Array()),
    (this.status = 0),
    ...
    (this.set_options = function () {
      (o.canvas_width = o.get_opt("width", o.canvas_width)),
        ...
        o.onmousedown_callback ||
          (o.onmousedown_callback = o.get_opt("on_model_mouseclick", null)),
    ...
    (this.set_or_update_geo_edges = function (e, t, a) {
      if (
        ...
        (e.x || e.y || e.z) &&
          e.edges.position.set(e.x ? e.x : 0, e.y ? e.y : 0, e.z ? e.z : 0),
    ...
    (this.onmousedown = function (e) {
      ...
      if (i.length > 0) {
        ...
        o.onmousedown_callback &&
          o.onmousedown_callback(i[0].object.model_id, e, i[0].distance, t);
      } else
        o.send_no_model_click_event && o.onmousedown_callback(null, e, 0, t);
    }),
    ...
    (this.get_model_filename = function (e, t, a, i) {
      ...
      return (
        e.orig_url && !i
          ...
          : e.filename &&
            (e.filename instanceof File && (n = File.name), (n = e.filename)),
        !n && t
          ? "model_" + e.id + ".stl"
          : n
          ? (a && (n = o.basename(n)), n)
    ...
    (this.add_model = function (e, t) {
      ...
      if (!o.ready)
        return (
          o.models_to_add.push(e), o.model_error("THREE JS files are not ready")
        );
    ...
    (this.calc_volume_and_area = function (e, t) {
      ...
      for (c = 0; c < p; c++)
        (o = e.vertices[e.faces[c].a].x * t),
          ...
          (h =
            ((m =
              e.vertices[e.faces[c].a].distanceTo(e.vertices[e.faces[c].b]) *
              t) +
              (u =
                e.vertices[e.faces[c].b].distanceTo(e.vertices[e.faces[c].c]) *
                t) +
              (f =
                e.vertices[e.faces[c].c].distanceTo(e.vertices[e.faces[c].a]) *
                t)) /
            2),
    ...
    (this.load_three = function (e) {
      ...
      var t = [
        ...
        e + "CanvasRenderer.js",
        e +
          (0 == o.controls_type ? "OrbitControls.js" : "TrackballControls.js"),
      ];
...
function ScriptsLoader() {
  ...
  (this.all_loaded_callback = null),
    ...
    (this.loading_scripts = new Array()),
    (this.loaded_scripts = new Array()),
