    ...
    case MSG_DATA:
      ...
      a.data.jszip_path && (jszip_path = a.data.jszip_path),
        a.data.data.local_file
          ? ((filename = a.data.data.local_file.name
              ? a.data.data.local_file.name
              : a.data.data.filename),
        ...
        (load_from_blob_or_ab = null),
        a.data.load_from_blob_or_ab &&
          (load_from_blob_or_ab = a.data.load_from_blob_or_ab),
